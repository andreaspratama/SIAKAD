...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <a href="/guru/exportexcel" class="btn btn-success btn-sm mb-3 mt-3 px-3 py-2">Laporan Excel</a>
        <a href="/guru/exportpdf" class="btn btn-danger btn-sm mb-3 mt-3 px-3 py-2">Laporan PDF</a>
                ...
                <tbody>
                  @forelse ($items as $item)
                    <tr>
                        ...
                        <td>{{$item->nama}}</td>
                        <td>
                            <a href="/guru/{{$item->id}}/show"" class="btn btn-circle btn-success btn-sm">
                                <i class="fa fa-eye"></i>
                            </a>
